...
public class EventQueryTodo extends BaseAct {
	...
	String url = PathConfig.ADDRESS+"/gsm/event/eevent/queryCurrentStepPage?rows=1000&page=1&sort=ID&order=desc&ukey="
			+ PathConfig.ukey;
...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);
	...
	private void initView() {
		...
		tvRight.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// Intent intent = new Intent(EventQueryTodo.this,
				// EventFilter.class);
	...
	protected void getData() {
		...
		if (null != esub) {
			...
			// params.put("START_DATEbetween", esub.getTime1());
			// params.put("CLOSETIMEbetween", esub.getTime2());
			// params.put("NAME_APPEALlike", esub.getEventName());
			// params.put("APPEAL_NAME", esub.getEventSuqiuren());
			// params.put("CODE_EVENT_TYPE", esub.getEventTypeCode());
			// params.put("CODE_EVENT_FROM", esub.getEventFromCode());
			// params.put("STEP_ID", esub.getEventStatusCode());
			// params.put("CODE_APPRAISE", esub.getEventYesCode());
		}
		...
		Request<JSONObject> request = new VolleyCommonPost(url, new Response.Listener<JSONObject>() {
			...
			public void onResponse(JSONObject response) {
				...
				mEventAllAdapter = new EventAllAdapter(data, listView, EventQueryTodo.this,
						PathConfig.event_status_todo);
	...
	// String jsondata = response.toString();
	// CommonBean temp0 = (CommonBean) JSON.parseObject(jsondata,
	// CommonBean.class);
	// total = temp0.getTotal();
	// data = (ArrayList<Map<String, Object>>) temp0.getRows();
	// mEventAllAdapter = new EventAllAdapter(data, listView,
	// EventQueryTodo.this,
	// PathConfig.event_status_todo);
	// listView.setAdapter(mEventAllAdapter);
	// if (total.equals("0")) {
