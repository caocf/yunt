...
public class EventQueryCancel extends BaseAct {
	...
	String url = PathConfig.ADDRESS+"/gsm/event/eevent/queryCloseEventPage?rows=1000&page=1&sort=ID&order=desc&ukey="
			+ PathConfig.ukey;
	...
	protected void getData() {
		...
		Request<JSONObject> request = new VolleyCommonPost(url, new Response.Listener<JSONObject>() {
			...
			public void onResponse(JSONObject response) {
				...
				mEventAllAdapter = new EventAllAdapter(data, listView, EventQueryCancel.this,
						PathConfig.event_status_close);
