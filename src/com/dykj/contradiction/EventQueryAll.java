...
public class EventQueryAll extends BaseAct {
	...
	String url = PathConfig.ADDRESS + "gsm/event/eevent/queryAllSearchPage?rows=1000&page=1&sort=code&order=desc&ukey="
			+ PathConfig.ukey;
	...
	protected void getData() {
		...
		Request<JSONObject> request = new VolleyCommonPost(url, new Response.Listener<JSONObject>() {
			...
			public void onResponse(JSONObject response) {
				...
				mEventAllAdapter = new EventAllAdapter(data, listView, EventQueryAll.this, 0);
