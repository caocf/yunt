...
public class DialogAct1 extends BaseAct {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialog0);
	...
	private void deletData() {
		showDialog();
		String url = PathConfig.ADDRESS + "/base/buserplate/delete?codes=" + code + ",";
		...
		StringRequest stringRequest = new StringRequest(url, new Response.Listener<String>() {
			...
			public void onResponse(String response) {
				...
				if (message.get("status").equals("true")) {
					ToastUtils.showSuperToastAlertGreen(DialogAct1.this, message.get("info"));
					finish();
				} else {
					ToastUtils.showSuperToastAlert(DialogAct1.this, message.get("info"));
					finish();
				}
