...
public class ParkDetailAct2 extends BaseAct implements OnClickListener {
	...
	private void initView() {
		...
		showDialog();
		tvXiaoqu = (TextView) this.findViewById(R.id.tvXiaoqu);// 小区
		tvMapAddress = (TextView) this.findViewById(R.id.tvMapAddress);// 描述地址
		tvCheWei = (TextView) this.findViewById(R.id.tvCheWei);// 车位
		tvXingqi = (TextView) this.findViewById(R.id.tvXingqi);// 星期
		tvTime = (TextView) this.findViewById(R.id.tvTime);// 时间
		tvMoney = (TextView) this.findViewById(R.id.tvMoney);// 租金
		tvOwnerPhone = (TextView) this.findViewById(R.id.tvOwnerPhone);// 电话
		...
		Request<JSONObject> request = new VolleyCommonPost(url, new Response.Listener<JSONObject>() {
			...
			public void onResponse(JSONObject response) {
				...
				if (message.get("status").equals("true")) {
					ToastUtils.showSuperToastAlertGreen(ParkDetailAct2.this, "提交成功");
