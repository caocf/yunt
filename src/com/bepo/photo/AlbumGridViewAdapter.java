...
import com.bepo.R;
import com.bepo.photo.BitmapCache.ImageCallback;
...
public class AlbumGridViewAdapter extends BaseAdapter {
	...
	private DisplayMetrics dm;// 获取分辨率
	BitmapCache cache;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.plugin_camera_select_imageview, parent,
					false);
