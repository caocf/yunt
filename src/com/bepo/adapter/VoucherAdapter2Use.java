...
public class VoucherAdapter2Use extends CustomAdapter {
	...
	public VoucherAdapter2Use(ArrayList<HashMap<String, String>> data, Context context) {
		super(data, context);
	}

	@SuppressWarnings("unchecked")
	public VoucherAdapter2Use(ArrayList<HashMap<String, String>> data, ListView listView, Context context) {
		super(data, context);
