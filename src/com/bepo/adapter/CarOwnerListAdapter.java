...
public class CarOwnerListAdapter extends CustomAdapter {
	...
	public CarOwnerListAdapter(ArrayList<HashMap<String, String>> data, Context context) {
		super(data, context);
	}

	@SuppressWarnings("unchecked")
	public CarOwnerListAdapter(ArrayList<HashMap<String, String>> data, ListView listView, Context context) {
		super(data, context);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (rowView == null) {
			...
			viewCache.linSiren = (LinearLayout) rowView.findViewById(R.id.linSiren);
	...
	private class ViewHolder {
		...
		public RelativeLayout rlPay, rlzxing;
		public LinearLayout linSiren;
