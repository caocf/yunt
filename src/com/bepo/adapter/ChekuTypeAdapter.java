...
public class ChekuTypeAdapter extends CustomAdapter {
	...
	public ChekuTypeAdapter(ArrayList<HashMap<String, String>> data, Context context) {
		super(data, context);
		...
		SubmitPark2.CodePosition = data.get(0).get("CODE");
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				BasicInfo4SubmitFragment.CodePosition = data.get(position).get("CODE");
				if (position == 0) {
					BasicInfo4SubmitFragment.rlChekuName.setVisibility(View.GONE);
				} else {
					BasicInfo4SubmitFragment.rlChekuName.setVisibility(View.VISIBLE);
				}
